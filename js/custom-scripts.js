...
function myFunction() {
    document.getElementById("myname").style.WebkitAnimationTimingFunction = "linear";  // Safari 4.0 - 8.0
    document.getElementById("myname").style.animationTimingFunction = "linear";
}
